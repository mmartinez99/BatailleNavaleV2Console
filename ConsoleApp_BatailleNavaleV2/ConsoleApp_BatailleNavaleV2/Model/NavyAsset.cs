...
namespace ConsoleApp_BatailleNavaleV2.Models
{
    class NavyAsset //Opérations du navire 
    {
        Random random = new Random();

        // Taille de chaques navires
        ...
        {//Verif que aucun navire soir sur les meme coordonnées
